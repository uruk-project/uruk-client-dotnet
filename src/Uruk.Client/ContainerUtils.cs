...
{
    // from https://github.com/dotnet/aspnetcore/blob/master/src/DataProtection/DataProtection/src/Internal/ContainerUtils.cs
    internal static class ContainerUtils
    {
        ...
        public static bool IsVolumeMountedFolder(string directory)
        {
            if (!IsContainer)
            {
                return false;
        ...
        private static bool IsDirectoryMounted(string directory, IEnumerable<string> fstab)
        {
